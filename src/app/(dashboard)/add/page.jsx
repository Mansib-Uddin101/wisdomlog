...
const AddPetForm = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        if (user?.email) {
            formValues.ownerEmail = user.email;
        }
                ...
                <div>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                        <div>
                            ...
                            <input name="petName" type="text" required placeholder="e.g., Luna" className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#D0623A] focus:border-transparent transition" />
                        </div>
