...
// Server-side data fetching for the dynamic section (Pure JavaScript)
const getFeaturedPets = async () => {
  try {
    ...
    // Slice to ensure we show a featured subset (Minimum 6 pets as required)
      ...
      <section className="w-5/6 mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="group cursor-pointer">
            <div className="aspect-video bg-slate-100 rounded-2xl mb-4 overflow-hidden border border-slate-100 flex items-center justify-center text-2xl">🥦</div>
      ...
      <section className="w-5/6 mx-auto border-t border-slate-100 pt-20">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 relative">
          <div className="space-y-2">
            <div className="text-3xl font-black text-orange-200">01</div>
            <h3 className="font-bold text-slate-800 text-sm">Select Your Pet</h3>
          ...
          <div className="space-y-2">
            <div className="text-3xl font-black text-orange-200">02</div>
            <h3 className="font-bold text-slate-800 text-sm">Submit Application</h3>
          ...
          <div className="space-y-2">
            <div className="text-3xl font-black text-orange-200">03</div>
          ...
          <div className="space-y-2">
            <div className="text-3xl font-black text-orange-200">04</div>
            <h3 className="font-bold text-slate-800 text-sm">Bring Them Home</h3>
